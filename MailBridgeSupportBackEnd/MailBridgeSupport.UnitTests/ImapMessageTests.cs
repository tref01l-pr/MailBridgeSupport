...
using MailBridgeSupport.UnitTests.MemberData;

namespace MailBridgeSupport.UnitTests;
...
public class ImapMessageTests
{
    ...
    public async Task Create_ShouldReturnNewImapMessage()
    {
        ...
        var messageStatus = MessageStatus.Question;
        ...
        Assert.Equal(messageStatus, result.Value.MessageStatus);
    }
