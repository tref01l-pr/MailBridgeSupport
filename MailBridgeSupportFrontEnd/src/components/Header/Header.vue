<template>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-background">
    <div class="container-fluid">
      <router-link to="/" class="navbar-brand">Finances</router-link>
<!--      <button
      ...
      <div v-if="isAuth" ref="navbarCollapse" class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <router-link to="/chats" class="nav-link" active-class="active" exact>Chats</router-link>
          </li>
<!--          <li v-if="isSystemAdmin" class="nav-item">
            <router-link to="/admin/users" class="nav-link" active-class="active" exact>UsersList</router-link>
          </li>-->
        </ul>
      </div>
      <div v-if="!isAuth">
